...
//     company: "Techinfinity",
//     description:
//       "Designed and developed dynamic UIs ensuring smooth integration of frontend with Django-based APIs and MySQL database.",
//     technologies: ["HTML", "CSS", "Django", "JavaScript", "MySQL"],
//   },
// ];
...
// const Exp = () => {
//   return (
//     <section className="relative py-16 px-6 md:px-20 bg-gradient-to-b from-neutral-950 to-black text-white overflow-hidden">
